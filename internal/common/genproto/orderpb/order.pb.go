...
func (x *CreateOrderReq) GetItems() []*ItemWithQuantity {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *GetOrderReq) GetCustomerID() string {
	if x != nil {
		return x.CustomerID
	}
	return ""
...
const file_orderpb_order_proto_rawDesc = "" +
	"\n" +
	"\x13orderpb/order.proto\x12\aorderpb\x1a\x1bgoogle/protobuf/empty.proto\"a\n" +
	"\x0eCreateOrderReq\x12\x1e\n" +
	"\n" +
	"CustomerID\x18\x01 \x01(\tR\n" +
	"CustomerID\x12/\n" +
	"\x05Items\x18\x02 \x03(\v2\x19.orderpb.ItemWithQuantityR\x05Items\"G\n" +
	...
	"\x05Items\x18\x04 \x03(\v2\r.orderpb.ItemR\x05Items2\xb7\x01\n" +
	"\fOrderService\x12>\n" +
	"\vCreateOrder\x12\x17.orderpb.CreateOrderReq\x1a\x16.google.protobuf.Empty\x120\n" +
	"\bGetOrder\x12\x14.orderpb.GetOrderReq\x1a\x0e.orderpb.Order\x125\n" +
	"\vUpdateOrder\x12\x0e.orderpb.Order\x1a\x16.google.protobuf.EmptyB5Z3github.com/Hypocrite/gorder/common/genproto/orderpbb\x06proto3"
...
var file_orderpb_order_proto_goTypes = []any{
	(*CreateOrderReq)(nil),   // 0: orderpb.CreateOrderReq
	(*GetOrderReq)(nil),      // 1: orderpb.GetOrderReq
...
var file_orderpb_order_proto_depIdxs = []int32{
	2, // 0: orderpb.CreateOrderReq.Items:type_name -> orderpb.ItemWithQuantity
	3, // 1: orderpb.Order.Items:type_name -> orderpb.Item
	0, // 2: orderpb.OrderService.CreateOrder:input_type -> orderpb.CreateOrderReq
	1, // 3: orderpb.OrderService.GetOrder:input_type -> orderpb.GetOrderReq
