...
type OrderServiceClient interface {
	CreateOrder(ctx context.Context, in *CreateOrderReq, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *orderServiceClient) CreateOrder(ctx context.Context, in *CreateOrderReq, opts ...grpc.CallOption) (*empty.Empty, error) {
...
type OrderServiceServer interface {
	CreateOrder(context.Context, *CreateOrderReq) (*empty.Empty, error)
...
func (UnimplementedOrderServiceServer) CreateOrder(context.Context, *CreateOrderReq) (*empty.Empty, error) {
