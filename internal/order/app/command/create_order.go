...
type CreateOrderHandler decorator.CommandHandler[CrateOrder, *CreateOrderResult]
...
func NewCreateOrderHandler(
	...
	return decorator.ApplyCommandDecorator[CrateOrder, *CreateOrderResult](
...
func (c createOrderHandler) Handle(ctx context.Context, cmd CrateOrder) (*CreateOrderResult, error) {
	...
	pendingOder, err := domain.NewPendingOrder(cmd.CustomerID, validItems)
	if err != nil {
		return nil, err
	}
	o, err := c.orderRepo.Create(ctx, pendingOder)
	if err != nil {
		return nil, err
	}
